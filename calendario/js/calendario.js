...
document.getElementById("atualizadoem").innerHTML="<p>Última atualização em: 27/08/2015<br>Este site é uma iniciativa autônoma que visa apenas facilitar a divulgação da programação do bloco, não possui ligação direta com a Brasil Soka Gakkai Internacional (BSGI)</p>";
